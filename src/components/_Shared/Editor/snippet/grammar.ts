...
export var ParserRules: NearleyRule[] = [
  ...
  {
    name: 'Snippet$ebnf$2$subexpression$1$ebnf$1',
    symbols: ['Text'],
    postprocess: id,
  },
  {
  ...
  {
    name: 'Snippet$ebnf$2$subexpression$1',
    symbols: ['Element', 'Snippet$ebnf$2$subexpression$1$ebnf$1'],
  },
  {
    name: 'Snippet$ebnf$2',
    symbols: ['Snippet$ebnf$2', 'Snippet$ebnf$2$subexpression$1'],
    postprocess: d => d[0].concat([d[1]]),
  },
  {
    name: 'Snippet',
    symbols: ['Snippet$ebnf$1', 'Snippet$ebnf$2'],
    postprocess: createSnippet,
  },
  ...
  {
    name: 'Text$ebnf$1',
    symbols: ['Text$ebnf$1', 'TextPartial'],
    postprocess: d => d[0].concat([d[1]]),
  },
  ...
  {
    name: 'TextPartial',
    symbols: [lexer.has('equals') ? { type: 'equals' } : equals],
    postprocess: id,
  },
  {
    name: 'TextPartial',
    symbols: [lexer.has('escape') ? { type: 'escape' } : escape],
    postprocess: createEscaped,
  },
  {
    name: 'Comment',
    symbols: [lexer.has('comment') ? { type: 'comment' } : comment],
    postprocess: createComment,
  },
  {
    name: 'Placeholder',
    symbols: [
      lexer.has('dollar') ? { type: 'dollar' } : dollar,
      lexer.has('int') ? { type: 'int' } : int,
    ],
    postprocess: createPlaceholderSimple,
  },
  {
    name: 'Placeholder',
    symbols: [
      lexer.has('dollar') ? { type: 'dollar' } : dollar,
      lexer.has('namedInt') ? { type: 'namedInt' } : namedInt,
      lexer.has('openTag') ? { type: 'openTag' } : openTag,
      lexer.has('name') ? { type: 'name' } : name,
      lexer.has('closeTag') ? { type: 'closeTag' } : closeTag,
    ],
    postprocess: createPlaceholderNamedSimple,
  },
  {
    name: 'Placeholder',
    symbols: [
    ...
    postprocess: createPlaceholderBlock,
  },
  {
    name: 'Placeholder',
    symbols: [
      ...
      lexer.has('int') ? { type: 'int' } : int,
      lexer.has('openTag') ? { type: 'openTag' } : openTag,
      lexer.has('intName') ? { type: 'intName' } : intName,
      lexer.has('closeTag') ? { type: 'closeTag' } : closeTag,
      lexer.has('close') ? { type: 'close' } : close,
    ],
    postprocess: createPlaceholderNamedBlock,
  },
  {
    name: 'Placeholder',
    symbols: [
    ...
    postprocess: createPlaceholderBlockWithArgument,
  },
  {
    name: 'Placeholder',
    symbols: [
    ...
    postprocess: createPlaceholderNamedBlockWithArgument,
  },
  {
    name: 'Placeholder',
    symbols: [
    ...
    postprocess: createPlaceholderTransform,
  },
  ...
  {
    name: 'Choice$ebnf$2$subexpression$1',
    symbols: [lexer.has('comma') ? { type: 'comma' } : comma, 'ChoiceOption'],
  },
  {
    name: 'Choice$ebnf$2',
    symbols: ['Choice$ebnf$2', 'Choice$ebnf$2$subexpression$1'],
    postprocess: d => d[0].concat([d[1]]),
  },
  {
    name: 'Choice',
    symbols: [
      ...
      lexer.has('open') ? { type: 'open' } : open,
      lexer.has('int') ? { type: 'int' } : int,
      lexer.has('pipe') ? { type: 'pipe' } : pipe,
      'Choice$ebnf$1',
      'Choice$ebnf$2',
      lexer.has('pipe') ? { type: 'pipe' } : pipe,
      lexer.has('close') ? { type: 'close' } : close,
    ],
    postprocess: createChoice,
  },
  {
    name: 'Variable',
    symbols: [
    ...
    postprocess: createVariableSimple,
  },
  {
    name: 'Variable',
    symbols: [
    ...
    postprocess: createVariableBlock,
  },
  {
    name: 'Variable',
    symbols: [
    ...
    postprocess: createVariableBlockWithArgument,
  },
  {
    name: 'Variable',
    symbols: [
    ...
    postprocess: createVariableTransform,
  },
  {
    name: 'Expansion',
    symbols: [
    ...
    postprocess: createExpansion,
  },
  {
    name: 'Expansion$ebnf$1$subexpression$1',
    symbols: ['ExpansionArgument'],
    postprocess: id,
  },
  { name: 'Expansion$ebnf$1', symbols: ['Expansion$ebnf$1$subexpression$1'] },
  {
    name: 'Expansion$ebnf$1$subexpression$2',
    symbols: ['ExpansionArgument'],
    postprocess: id,
  },
  {
    name: 'Expansion$ebnf$1',
    symbols: ['Expansion$ebnf$1', 'Expansion$ebnf$1$subexpression$2'],
    postprocess: d => d[0].concat([d[1]]),
  },
  {
    name: 'Expansion$ebnf$2',
    symbols: [lexer.has('newline') ? { type: 'newline' } : newline],
    postprocess: id,
  },
  { name: 'Expansion$ebnf$2', symbols: [], postprocess: () => null },
  {
    ...
    postprocess: createExpansionWithArgument,
  },
  {
    name: 'Slot$subexpression$1',
  ...
  },
  {
    ...
    symbols: [
      lexer.has('dollar') ? { type: 'dollar' } : dollar,
      lexer.has('exclamation') ? { type: 'exclamation' } : exclamation,
      'Slot$subexpression$1',
    ],
    postprocess: createSlot,
  },
  {
    name: 'Action',
    symbols: [
    ...
    postprocess: createAction,
  },
  {
    name: 'Action$ebnf$1$subexpression$1',
    symbols: [lexer.has('colon') ? { type: 'colon' } : colon, 'TextArgument'],
  },
  { name: 'Action$ebnf$1', symbols: ['Action$ebnf$1$subexpression$1'] },
  {
    name: 'Action$ebnf$1$subexpression$2',
    symbols: [lexer.has('colon') ? { type: 'colon' } : colon, 'TextArgument'],
  },
  {
    name: 'Action$ebnf$1',
    symbols: ['Action$ebnf$1', 'Action$ebnf$1$subexpression$2'],
    postprocess: d => d[0].concat([d[1]]),
  },
  {
    name: 'Action',
    ...
    postprocess: createActionWithArguments,
  },
  { name: 'Condition$ebnf$1', symbols: [] },
  {
    name: 'Condition$ebnf$1$subexpression$1',
    symbols: [
      lexer.has('operator') ? { type: 'operator' } : operator,
      'Evaluation',
    ],
  },
  {
  ...
  },
  {
    ...
    postprocess: createCondition,
  },
  {
    name: 'Transform$ebnf$1',
    symbols: [lexer.has('text') ? { type: 'text' } : text],
    postprocess: id,
  },
  ...
  {
    name: 'Transform$ebnf$2$subexpression$1$ebnf$1',
    symbols: [lexer.has('text') ? { type: 'text' } : text],
    postprocess: id,
  },
  {
  ...
  {
    name: 'Transform$ebnf$2$subexpression$1',
    symbols: ['FormatString', 'Transform$ebnf$2$subexpression$1$ebnf$1'],
  },
  {
    name: 'Transform$ebnf$2',
    symbols: ['Transform$ebnf$2', 'Transform$ebnf$2$subexpression$1'],
    postprocess: d => d[0].concat([d[1]]),
  },
  {
    name: 'Transform$ebnf$3',
    symbols: [lexer.has('text') ? { type: 'text' } : text],
    postprocess: id,
  },
  ...
  },
  {
    ...
    postprocess: createFormatStringSimple,
  },
  {
    name: 'FormatString',
    symbols: [
    ...
    postprocess: createFormatStringBlock,
  },
  {
    name: 'FormatString',
    symbols: [
      ...
      lexer.has('int') ? { type: 'int' } : int,
      lexer.has('colon') ? { type: 'colon' } : colon,
      lexer.has('caseModifier') ? { type: 'caseModifier' } : caseModifier,
      lexer.has('close') ? { type: 'close' } : close,
    ],
    postprocess: createFormatStringCaseModifier,
  },
  {
    name: 'FormatString',
    symbols: [
      ...
      lexer.has('condition') ? { type: 'condition' } : condition,
      lexer.has('close') ? { type: 'close' } : close,
    ],
    postprocess: createFormatStringIfCondition,
  },
  {
    name: 'FormatString',
    symbols: [
      ...
      lexer.has('int') ? { type: 'int' } : int,
      lexer.has('colon') ? { type: 'colon' } : colon,
      lexer.has('questionmark') ? { type: 'questionmark' } : questionmark,
      lexer.has('condition') ? { type: 'condition' } : condition,
      lexer.has('colon') ? { type: 'colon' } : colon,
      lexer.has('condition') ? { type: 'condition' } : condition,
      lexer.has('close') ? { type: 'close' } : close,
    ],
    postprocess: createFormatStringIfElseCondition,
  },
  {
    name: 'FormatString$ebnf$1',
  ...
  { name: 'FormatString$ebnf$1', symbols: [], postprocess: () => null },
  {
    ...
    postprocess: createFormatStringElseCondition,
  },
  ...
  { name: 'ChoiceOption', symbols: ['TextArgument'], postprocess: id },
  {
    ...
    symbols: [
      ...
      lexer.has('open') ? { type: 'open' } : open,
      lexer.has('int') ? { type: 'int' } : int,
      lexer.has('operatorColon') ? { type: 'operatorColon' } : operatorColon,
      lexer.has('operator') ? { type: 'operator' } : operator,
      lexer.has('colon') ? { type: 'colon' } : colon,
      'TextArgument',
      lexer.has('close') ? { type: 'close' } : close,
    ],
    postprocess: createPlaceholderEvaluation,
  },
  {
    name: 'Evaluation',
    symbols: [
    ...
    postprocess: createVariableEvaluation,
  },
  { name: 'TextArgument$ebnf$1', symbols: [] },
  {
    name: 'TextArgument$ebnf$1',
    symbols: ['TextArgument$ebnf$1', 'TextArgumentPartial'],
    postprocess: d => d[0].concat([d[1]]),
  },
  {
    name: 'TextArgument',
    symbols: ['TextArgument$ebnf$1'],
    postprocess: createText,
  },
  {
    name: 'TextArgumentPartial',
    symbols: [lexer.has('text') ? { type: 'text' } : text],
    postprocess: id,
  },
  {
  ...
  {
    name: 'ExpansionArgument$subexpression$1',
    symbols: [lexer.has('name') ? { type: 'name' } : name],
    postprocess: id,
  },
  {
  ...
  {
    name: 'ExpansionArgument',
    symbols: [
      lexer.has('newline') ? { type: 'newline' } : newline,
      lexer.has('slash') ? { type: 'slash' } : slash,
      'ExpansionArgument$subexpression$1',
      lexer.has('colon') ? { type: 'colon' } : colon,
      'Snippet',
    ],
    postprocess: createExpansionArgument,
  },
]
