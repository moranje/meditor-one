import SnippetController from '@/snippet-service/controller'
import * as monaco from 'monaco-editor/esm/vs/editor/editor.api'
import { dispose, IDisposable } from 'vs/base/common/lifecycle'
import { Text } from '@/snippet-service/classes'
import { ICodeEditor } from 'vs/editor/browser/editorBrowser'
import { SuggestController } from 'vs/editor/contrib/suggest/suggestController'
import { showSimpleSuggestions } from '../../node_modules/monaco-editor/esm/vs/editor/contrib/suggest/suggest'
...
export default class MonacoSnippetController extends SnippetController {
  ...
  private _handleChoice() {
    ...
    if (this._currentChoice !== choice) {
      ...
      let mapped = choice.children.map((option: Text, i) => {
      ...
      showSimpleSuggestions(this._editor, mapped)
    }
  }
