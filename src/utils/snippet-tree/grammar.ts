...
export var ParserRules: NearleyRule[] = [
  ...
  {
    name: 'Snippet$ebnf$1',
    symbols: ['Snippet$ebnf$1', 'Snippet$ebnf$1$subexpression$1'],
  ...
  {
    name: 'FormatOrReplacement',
    symbols: [lexer.has('replacement') ? { type: 'replacement' } : replacement]
  },
  {
    name: 'Transform$ebnf$1$subexpression$1',
    symbols: ['FormatOrReplacement']
  },
  { name: 'Transform$ebnf$1', symbols: ['Transform$ebnf$1$subexpression$1'] },
  {
    name: 'Transform$ebnf$1$subexpression$2',
    symbols: ['FormatOrReplacement']
  },
  {
    name: 'Transform$ebnf$1',
    symbols: ['Transform$ebnf$1', 'Transform$ebnf$1$subexpression$2'],
    postprocess: d => d[0].concat([d[1]])
  },
  {
    name: 'Transform$ebnf$2',
    symbols: [lexer.has('flags') ? { type: 'flags' } : flags],
    postprocess: id
  },
  { name: 'Transform$ebnf$2', symbols: [], postprocess: () => null },
  {
    ...
    symbols: [
      ...
      lexer.has('pattern') ? { type: 'pattern' } : pattern,
      lexer.has('slash') ? { type: 'slash' } : slash,
      'Transform$ebnf$1',
      lexer.has('slash') ? { type: 'slash' } : slash,
      'Transform$ebnf$2'
  ...
  },
  {
    ...
    postprocess: tabstop.incrementor
  },
  {
    name: 'Tabstop',
    symbols: [
  ...
  },
  {
    ...
    postprocess: tabstop.blockAnchor
  },
  {
    name: 'Tabstop',
    symbols: [
    ...
    postprocess: tabstop.blockIncrementor
  },
  {
    name: 'Tabstop',
    symbols: [
  ...
  },
  {
    ...
    postprocess: tabstop.rules.noIncrementorInteger
  },
  {
    name: 'Placeholder',
    symbols: [
    ...
    postprocess: placeholder.simple
  },
  {
    name: 'Placeholder',
    symbols: [
    ...
    postprocess: placeholder.anchor
  },
  {
    name: 'Placeholder',
    symbols: [
    ...
    postprocess: placeholder.incrementor
  },
  {
    name: 'Placeholder',
    symbols: [
    ...
    postprocess: placeholder.rules.noIncrementorInteger
  },
  { name: 'Choice$ebnf$1', symbols: [] },
  {
    name: 'Choice$ebnf$1$subexpression$1',
    symbols: [lexer.has('comma') ? { type: 'comma' } : comma, 'TextOrExpansion']
  },
  {
    name: 'Choice$ebnf$1',
    symbols: ['Choice$ebnf$1', 'Choice$ebnf$1$subexpression$1'],
    postprocess: d => d[0].concat([d[1]])
  },
  {
    name: 'Choice',
  ...
  },
  {
    ...
    postprocess: choice.anchor
  },
  { name: 'Choice$ebnf$3', symbols: [] },
  {
    name: 'Choice$ebnf$3$subexpression$1',
    symbols: [lexer.has('comma') ? { type: 'comma' } : comma, 'TextOrExpansion']
  },
  {
    name: 'Choice$ebnf$3',
    symbols: ['Choice$ebnf$3', 'Choice$ebnf$3$subexpression$1'],
    postprocess: d => d[0].concat([d[1]])
  },
  {
    name: 'Choice',
    ...
    postprocess: choice.incrementor
  },
  { name: 'Choice$ebnf$4', symbols: [] },
  {
    name: 'Choice$ebnf$4$subexpression$1',
    symbols: [lexer.has('comma') ? { type: 'comma' } : comma, 'TextOrExpansion']
  },
  {
    name: 'Choice$ebnf$4',
    symbols: ['Choice$ebnf$4', 'Choice$ebnf$4$subexpression$1'],
    postprocess: d => d[0].concat([d[1]])
  },
  {
    name: 'Choice',
    ...
    postprocess: choice.rules.noIncrementorInteger
  },
  {
    name: 'Variable',
    symbols: [
  ...
  },
  {
    ...
    postprocess: variable.placeholder
  },
  {
    name: 'Variable',
    symbols: [
    ...
    postprocess: variable.transform
  },
  { name: 'Expansion$ebnf$1', symbols: [] },
  {
    name: 'Expansion$ebnf$1$subexpression$1',
    symbols: [lexer.has('colon') ? { type: 'colon' } : colon, 'Snippet']
  },
  {
    name: 'Expansion$ebnf$1',
    symbols: ['Expansion$ebnf$1', 'Expansion$ebnf$1$subexpression$1'],
    postprocess: d => d[0].concat([d[1]])
  },
  {
    name: 'Expansion',
  ...
  },
  {
    name: 'Comment',
    symbols: [
      lexer.has('inlineComment') ? { type: 'inlineComment' } : inlineComment
    ],
    postprocess: comment
  },
